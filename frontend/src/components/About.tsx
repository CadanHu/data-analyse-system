            ...
            <section className="bg-[#111827]/50 border border-white/10 rounded-2xl p-8 md:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <ValueCard
                  ...
                  description="Integrated R1 deep thinking model, providing transparent and traceable thinking chains with ultra-high precision SQL generation."
                  icon={
                ...
                />
                <ValueCard
                  title="SQLAlchemy Async Architecture"
                  description="Based on SQLAlchemy 2.0, achieving high-performance async execution with smooth multi-database switching between MySQL and PostgreSQL."
                  icon={
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <ValueCard
                  ...
                  description="Auto-adapt 15+ professional visualization solutions including radar charts, funnel charts, and Sankey diagrams for clear data insights."
                  icon={
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                />
                <ValueCard
                  title="RAG Knowledge Base Enhancement"
                  description="Support PDF and Excel deep parsing, enabling AI to perform precise analysis based on private business terminology."
                  icon={
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <section className="bg-[#111827]/50 border border-white/10 rounded-2xl p-8 md:p-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-400">{t('about.teamMembers')}</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#f59e0b] mb-2">10M+</div>
                  <div className="text-sm text-gray-400">{t('about.queries')}</div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-[#111827]/50 border border-white/10 rounded-2xl p-8 md:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <ContactCard
                  ...
                  title="Address"
                  content="Chaoyang District, Beijing"
                />
                <ContactCard
                  icon={
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
