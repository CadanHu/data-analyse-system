...
export default function Features() {
  ...
  return (
    <div className="min-h-screen bg-[#050810] text-white">
      <nav className="fixed top-0 left-0 right-0 z-[100] px-6 py-4 backdrop-blur-xl border-b border-white/10 bg-[#050810]/95" style={{ paddingTop: 'calc(var(--safe-top) + 1rem)' }}>
